...
with open(file_to_load) as emp_data:
    ...
    for row in reader:
        ...
        emp.states.append(state_abbrev)

# Zip all of the new lists together
# empzip = zip 
empzip= zip(indexes, employees, department)

# Write all of the election data to csv
# YOUR CODE HERE
with open(output_path, 'w', newline='') as csvfile:
output_path = os.path.join("Resources", "output", "employee_data_reformatted.csv")